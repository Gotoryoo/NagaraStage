...
namespace NagaraStage.Activities {
    class Full_Automatic_Tracking : Activity, IActivity {
        private static Full_Automatic_Tracking instance;
        ...
        public Full_Automatic_Tracking(ParameterManager _paramaterManager)
        ...
        /// </summary>
        /// <returns></returns>
        public static Full_Automatic_Tracking GetInstance(
            ParameterManager parameterManger = null) {
            if (instance == null) {
                instance = new Full_Automatic_Tracking(parameterManger);
            }
            return instance;
        }
