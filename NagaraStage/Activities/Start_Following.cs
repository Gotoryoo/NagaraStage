...
namespace NagaraStage.Activities {
    class Start_Following : Activity, IActivity {
        private static Start_Following instance;
        ...
        public Start_Following(ParameterManager _paramaterManager)
        ...
        /// </summary>
        /// <returns></returns>
        public static Start_Following GetInstance(
            ParameterManager parameterManger = null) {
            if (instance == null) {
                instance = new Start_Following(parameterManger);
            }
            return instance;
        }
